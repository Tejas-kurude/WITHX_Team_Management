...
r.post('/tasks', authenticate, allowRoles('SUPER_ADMIN', 'ADMIN', 'TEAM_LEAD'), c.createTask);
r.put('/tasks/:id', authenticate, c.updateTask);
r.post('/tasks/:id/submit', authenticate, c.submitTaskForReview);
r.post('/tasks/:id/review', authenticate, allowRoles('SUPER_ADMIN', 'ADMIN', 'TEAM_LEAD'), c.reviewTask);
r.put('/tasks/:id/admin', authenticate, allowRoles('SUPER_ADMIN'), c.adminUpdateTask);
r.delete('/tasks/:id', authenticate, allowRoles('SUPER_ADMIN'), c.deleteTask);
...
r.get('/work-hours', authenticate, allowRoles('SUPER_ADMIN', 'ADMIN'), c.listWorkHours);
r.post('/work-hours', authenticate, allowRoles('SUPER_ADMIN', 'ADMIN'), c.saveWorkHours);
r.delete('/work-hours/:id', authenticate, allowRoles('SUPER_ADMIN', 'ADMIN'), c.deleteWorkHours);
