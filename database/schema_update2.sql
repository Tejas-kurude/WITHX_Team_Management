...
CREATE TABLE IF NOT EXISTS performance_scores (
  ...
  task_completion NUMERIC(12,8) NOT NULL,
  on_time NUMERIC(5,2) NOT NULL,
  attendance NUMERIC(12,8) NOT NULL,
  punctuality NUMERIC(5,2) NOT NULL,
  report_consistency NUMERIC(5,2) NOT NULL,
  working_hours NUMERIC(12,8) NOT NULL DEFAULT 0,
  required_work_hours NUMERIC(12,8) NOT NULL DEFAULT 3.00,
  task_deduction NUMERIC(12,8) NOT NULL DEFAULT 0,
  leave_deduction NUMERIC(12,8) NOT NULL DEFAULT 0,
  deductions NUMERIC(12,8) NOT NULL DEFAULT 0,
  score NUMERIC(12,8) NOT NULL,
  attendance_required_minutes NUMERIC(12,4) NOT NULL DEFAULT 0,
  attendance_worked_minutes NUMERIC(12,4) NOT NULL DEFAULT 0,
  attendance_missing_minutes NUMERIC(12,4) NOT NULL DEFAULT 0,
  attendance_deduction NUMERIC(12,8) NOT NULL DEFAULT 0,
  task_count INTEGER NOT NULL DEFAULT 0,
  task_total_score NUMERIC(12,8) NOT NULL DEFAULT 0,
  task_deadline_days INTEGER NOT NULL DEFAULT 5,
  task_late_deduction_per_day NUMERIC(12,8) NOT NULL DEFAULT 20,
  total_working_days INTEGER NOT NULL DEFAULT 26,
  task_details JSONB NOT NULL DEFAULT '[]'::jsonb,
  base_pay NUMERIC(14,2),
  base_pay_label VARCHAR(40),
  created_at TIMESTAMPTZ DEFAULT now()
);
